...
const Textarea = React.forwardRef<HTMLTextAreaElement, TextareaProps>(
  ({ className, color, size = 'default', ...props }, ref) => {
    return (
      <textarea
        className={cn(
          'flex min-h-[64px] border rounded-2xl w-full font-body text-sm font-normal bg-background text-foreground placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-none disabled:cursor-not-allowed disabled:opacity-50',
          // Size variants
          {
